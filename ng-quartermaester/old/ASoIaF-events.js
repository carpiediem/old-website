...
$(function(){
  ...
  */
  ...
  var displayInstead = window.location.href.match(/display\=([^&]+)/);
  displayInstead = (displayInstead!=null) ? displayInstead[1] : "";
  ...
  if (urlLocation!="") {
    ...
    var nameToShow = (displayInstead=="") ? urlLocation.replace(/\_/gi," ").replace(/\%27/gi,"'") : decodeURI(displayInstead);
    
    new google.maps.InfoWindow({content:arms+nameToShow+house, position:center}).open(map);
  }
